...
// 1/13/2010 - dkoes - adapted to standalone form
...
public:
  ...
  virtual void getExtraOptionNames(vector<const char*> &) {}

  // addOccurrence - Wrapper around handleOccurrence that enforces Flags.
  //
  bool addOccurrence(unsigned pos, const string& ArgName,
...
class ValuesClass {
  ...
  vector<std::pair<const char *, std::pair<int, const char *> > > Values;
...
struct generic_parser_base {
  ...
  void getExtraOptionNames(vector<const char*> &OptionNames) {
...
public:
  ...
  bool parse(Option &O, const string& ArgName, const string& Arg, DataType &V) {
    string ArgVal;
    if (hasArgStr)
      ArgVal = Arg;
    else
...
public:
  ...
  void getExtraOptionNames(vector<const char*> &) {}
...
public:
  ...
  // parse - Return true on error.
  bool parse(Option &O, const string& ArgName, const string& Arg, bool &Val);
...
public:
  // parse - Return true on error.
  bool parse(Option &O, const string& ArgName, const string& Arg, boolOrDefault &Val);
...
public:
  // parse - Return true on error.
  bool parse(Option &O, const string& ArgName, const string& Arg, int &Val);
...
public:
  // parse - Return true on error.
  bool parse(Option &O, const string& ArgName, const string& Arg, unsigned &Val);
...
public:
  // parse - Return true on error.
  bool parse(Option &O, const string& ArgName, const string& Arg, double &Val);
...
public:
  // parse - Return true on error.
  bool parse(Option &O, const string& ArgName, const string& Arg, float &Val);
...
public:
  // parse - Return true on error.
  bool parse(Option &, const string&, const string& Arg, std::string &Value) {
    Value = Arg;
    return false;
  }
...
public:
  // parse - Return true on error.
  bool parse(Option &, const string&, const string& Arg, char &Value) {
    Value = Arg[0];
    return false;
  }
